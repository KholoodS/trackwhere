...
<div class="app-brand justify-content-center">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">Trackwhere</span>
                        </a>
                    </div>
                    ...
                    <?php echo form_open('register/signin'); ?> 
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            echo form_checkbox($terms_data);
                            ?>
                            <label class="form-check-label" for="terms-conditions">
                                I agree to <a href="">privacy policy & terms</a>
                            </label>
                        </div>
                        <?php echo form_error('terms', '<div class="alert alert-danger">', '</div>'); ?>
                    </div>
                    
                    <?php echo form_submit('submit', 'Sign up', array('class' => 'btn btn-primary d-grid w-100')); ?>
